...
def get_text_chunks_langchain(text, source, chunk_size, chunk_overlap, token_limit, text_splitter_choice):
...
def add_json_html_data_to_vector_db(vectordb, file_path, content_key, index_key, chunk_size, chunk_overlap, token_limit, text_splitter_choice):
    ...
    for content in json_data:
        ...
        chunks = get_text_chunks_langchain(text, content[index_key], chunk_size=chunk_size, chunk_overlap=chunk_overlap, token_limit=token_limit, text_splitter_choice=text_splitter_choice)
...
def ingest_call(vectordb, chunk_size, chunk_overlap, token_limit, text_splitter_choice):
    ...
    add_json_html_data_to_vector_db(
        ...
        chunk_size= chunk_size, chunk_overlap=chunk_overlap, token_limit=token_limit, text_splitter_choice=text_splitter_choice
    )
...
def run_embedding_func_and_eval_retrieval(embeddings, chunk_size, chunk_overlap, text_splitter_choice):
    ...
    ingest_call(vectordb=vectordb, chunk_size=chunk_size, chunk_overlap=chunk_overlap, token_limit= embeddings["token_limit"], text_splitter_choice=text_splitter_choice)
...
for embedding in EMBEDDINGS:
    ...
    results = run_embedding_func_and_eval_retrieval(EMBEDDINGS[embedding], chunk_size=chunk_size, chunk_overlap=chunk_overlap, text_splitter_choice=text_splitter_choice)
