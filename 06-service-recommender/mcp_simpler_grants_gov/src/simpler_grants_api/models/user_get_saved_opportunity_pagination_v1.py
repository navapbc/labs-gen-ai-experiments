...
class UserGetSavedOpportunityPaginationV1(BaseModel):
    ...
    :type sort_order: List[SortOrderUserGetSavedOpportunityPaginationV1], optional
    """
    ...
    def __init__(
        ...
        page_offset: int,
        page_size: int,
        sort_order: List[SortOrderUserGetSavedOpportunityPaginationV1] = SENTINEL,
        **kwargs,
    ):
        """UserGetSavedOpportunityPaginationV1
        ...
        if sort_order is not SENTINEL:
            self.sort_order = self._define_list(
                sort_order, SortOrderUserGetSavedOpportunityPaginationV1
            )
        self._kwargs = kwargs
