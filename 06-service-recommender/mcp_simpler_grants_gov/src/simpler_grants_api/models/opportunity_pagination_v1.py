...
from .sort_order_opportunity_pagination_v1 import SortOrderOpportunityPaginationV1
...
class OpportunityPaginationV1(BaseModel):
    ...
    :type sort_order: List[SortOrderOpportunityPaginationV1], optional
    """
    ...
    def __init__(
        ...
        page_offset: int,
        page_size: int,
        sort_order: List[SortOrderOpportunityPaginationV1] = SENTINEL,
        **kwargs,
    ):
        """OpportunityPaginationV1
        ...
        if sort_order is not SENTINEL:
            self.sort_order = self._define_list(
                sort_order, SortOrderOpportunityPaginationV1
            )
        self._kwargs = kwargs
