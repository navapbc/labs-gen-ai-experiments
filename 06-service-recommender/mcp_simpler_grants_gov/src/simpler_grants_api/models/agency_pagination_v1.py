...
from .sort_order_agency_pagination_v1 import SortOrderAgencyPaginationV1
...
class AgencyPaginationV1(BaseModel):
    ...
    :type sort_order: List[SortOrderAgencyPaginationV1], optional
    """
    ...
    def __init__(
        ...
        page_offset: int,
        page_size: int,
        sort_order: List[SortOrderAgencyPaginationV1] = SENTINEL,
        **kwargs,
    ):
        """AgencyPaginationV1
        ...
        if sort_order is not SENTINEL:
            self.sort_order = self._define_list(sort_order, SortOrderAgencyPaginationV1)
        self._kwargs = kwargs
