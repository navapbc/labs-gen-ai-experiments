...
class AgencyFilterV1(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["active", "agency_id"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of AgencyFilterV1 from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of AgencyFilterV1 from a dict"""
        if obj is None:
            return None
