...
class ExtractMetadataRequest(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["data", "filters", "message", "pagination", "status_code"]
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": obj.get("data"),
            "filters": ExtractMetadataFilterV1.from_dict(obj.get("filters")) if obj.get("filters") is not None else None,
            "message": obj.get("message"),
            "pagination": ExtractMetadataPaginationV1.from_dict(obj.get("pagination")) if obj.get("pagination") is not None else None,
