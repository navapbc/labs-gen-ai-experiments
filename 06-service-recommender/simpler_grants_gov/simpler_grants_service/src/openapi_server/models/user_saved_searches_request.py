...
class UserSavedSearchesRequest(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of UserSavedSearchesRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of UserSavedSearchesRequest from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "pagination": UserGetSavedSearchPaginationV1.from_dict(obj.get("pagination")) if obj.get("pagination") is not None else None
        })
        return _obj
