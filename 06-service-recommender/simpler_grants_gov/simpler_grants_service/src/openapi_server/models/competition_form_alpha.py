...
class CompetitionFormAlpha(BaseModel):
    ...
    is_required: Optional[StrictBool] = Field(default=None, description="Whether the form is required for all applications to the competition")
    __properties: ClassVar[List[str]] = ["form", "is_required"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of CompetitionFormAlpha from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of CompetitionFormAlpha from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "form": FormAlpha.from_dict(obj.get("form")) if obj.get("form") is not None else None,
