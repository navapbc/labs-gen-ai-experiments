...
class UserSaveSearchRequest(BaseModel):
    ...
    """ # noqa: E501
    name: StrictStr = Field(description="Name of the saved search")
    search_query: Optional[Dict[str, Any]] = None
    __properties: ClassVar[List[str]] = ["name", "search_query"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of UserSaveSearchRequest from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of UserSaveSearchRequest from a dict"""
        if obj is None:
            return None
