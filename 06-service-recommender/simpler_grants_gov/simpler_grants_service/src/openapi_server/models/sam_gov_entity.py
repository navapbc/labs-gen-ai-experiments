...
class SamGovEntity(BaseModel):
    ...
    legal_business_name: Optional[StrictStr] = None
    uei: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["expiration_date", "legal_business_name", "uei"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of SamGovEntity from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of SamGovEntity from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "legal_business_name": obj.get("legal_business_name"),
            "uei": obj.get("uei")
        })
        return _obj
