...
from openapi_server.models.competition_alpha import CompetitionAlpha
from openapi_server.models.opportunity_assistance_listing_v1 import OpportunityAssistanceListingV1
from openapi_server.models.opportunity_attachment_v1 import OpportunityAttachmentV1
try:
...
class OpportunityWithAttachmentsV1(BaseModel):
    ...
    attachments: Optional[List[OpportunityAttachmentV1]] = Field(default=None, description="List of attachments associated with the opportunity")
    ...
    competitions: Optional[List[CompetitionAlpha]] = Field(default=None, description="List of competitions associated with the opportunity")
    ...
    __properties: ClassVar[List[str]] = ["agency", "agency_code", "agency_name", "attachments", "category", "category_explanation", "competitions", "created_at", "opportunity_assistance_listings", "opportunity_id", "opportunity_number", "opportunity_status", "opportunity_title", "summary", "top_level_agency_name", "updated_at"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of OpportunityWithAttachmentsV1 from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of OpportunityWithAttachmentsV1 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "attachments": [OpportunityAttachmentV1.from_dict(_item) for _item in obj.get("attachments")] if obj.get("attachments") is not None else None,
            "category": obj.get("category"),
            "category_explanation": obj.get("category_explanation"),
            "competitions": [CompetitionAlpha.from_dict(_item) for _item in obj.get("competitions")] if obj.get("competitions") is not None else None,
