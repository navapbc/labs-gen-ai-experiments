...
class AssistanceListingNumberFilterV1(BaseModel):
    """
    AssistanceListingNumberFilterV1
    """ # noqa: E501
    one_of: Optional[Annotated[List[Annotated[str, Field(strict=True)]], Field(min_length=1)]] = None
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of AssistanceListingNumberFilterV1 from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of AssistanceListingNumberFilterV1 from a dict"""
        if obj is None:
            return None
