...
class EstimatedTotalProgramFundingFilterV1(BaseModel):
    ...
    """ # noqa: E501
    max: Optional[Annotated[int, Field(strict=True, ge=0)]] = None
    min: Optional[Annotated[int, Field(strict=True, ge=0)]] = None
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of EstimatedTotalProgramFundingFilterV1 from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of EstimatedTotalProgramFundingFilterV1 from a dict"""
        if obj is None:
            return None
