...
class SortOrderAgencySearchPaginationV1(BaseModel):
    ...
    def order_by_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('agency_code', 'agency_name',):
            raise ValueError("must be one of enum values ('agency_code', 'agency_name')")
        return value
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of SortOrderAgencySearchPaginationV1 from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of SortOrderAgencySearchPaginationV1 from a dict"""
        if obj is None:
            return None
