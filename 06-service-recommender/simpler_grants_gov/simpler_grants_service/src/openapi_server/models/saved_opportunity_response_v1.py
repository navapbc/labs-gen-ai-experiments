...
class SavedOpportunityResponseV1(BaseModel):
    ...
    """ # noqa: E501
    opportunity_id: Optional[StrictInt] = Field(default=None, description="The ID of the saved opportunity")
    ...
    __properties: ClassVar[List[str]] = ["opportunity_id", "opportunity_status", "opportunity_title", "summary"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of SavedOpportunityResponseV1 from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of SavedOpportunityResponseV1 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "summary": SavedOpportunitySummaryV1.from_dict(obj.get("summary")) if obj.get("summary") is not None else None
        })
        return _obj
