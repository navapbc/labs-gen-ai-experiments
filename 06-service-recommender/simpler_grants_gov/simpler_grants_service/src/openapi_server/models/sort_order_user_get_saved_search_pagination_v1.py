...
class SortOrderUserGetSavedSearchPaginationV1(BaseModel):
    ...
    def order_by_validate_enum(cls, value):
        """Validates the enum"""
        if value not in ('created_at', 'updated_at', 'name',):
            raise ValueError("must be one of enum values ('created_at', 'updated_at', 'name')")
        return value
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of SortOrderUserGetSavedSearchPaginationV1 from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of SortOrderUserGetSavedSearchPaginationV1 from a dict"""
        if obj is None:
            return None
