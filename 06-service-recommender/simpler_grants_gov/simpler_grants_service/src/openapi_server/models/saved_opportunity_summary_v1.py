...
class SavedOpportunitySummaryV1(BaseModel):
    ...
    """ # noqa: E501
    close_date: Optional[date] = Field(default=None, description="The date the opportunity will close")
    is_forecast: Optional[StrictBool] = Field(default=None, description="Whether the opportunity is forecasted")
    post_date: Optional[date] = Field(default=None, description="The date the opportunity was posted")
    __properties: ClassVar[List[str]] = ["close_date", "is_forecast", "post_date"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of SavedOpportunitySummaryV1 from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of SavedOpportunitySummaryV1 from a dict"""
        if obj is None:
            return None
