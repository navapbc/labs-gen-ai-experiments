...
class ValidationIssue(BaseModel):
    ...
    ValidationIssue
    """ # noqa: E501
    var_field: Optional[StrictStr] = Field(default=None, description="The field that failed", alias="field")
    ...
    value: Optional[StrictStr] = Field(default=None, description="The value that failed")
    __properties: ClassVar[List[str]] = ["field", "message", "type", "value"]
