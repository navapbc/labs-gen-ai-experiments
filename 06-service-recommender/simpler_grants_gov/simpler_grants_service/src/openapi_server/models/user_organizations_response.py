...
class UserOrganizationsResponse(BaseModel):
    ...
    """ # noqa: E501
    data: Optional[List[UserOrganization]] = Field(default=None, description="List of organizations the user is associated with")
    ...
    def from_dict(cls, obj: Dict) -> Self:
        ...
        _obj = cls.model_validate({
            "data": [UserOrganization.from_dict(_item) for _item in obj.get("data")] if obj.get("data") is not None else None,
