...
class SortOrder(BaseModel):
    ...
    SortOrder
    """ # noqa: E501
    order_by: Optional[StrictStr] = Field(default=None, description="The field that the records were sorted by")
    sort_direction: Optional[StrictStr] = Field(default=None, description="The direction the records are sorted")
