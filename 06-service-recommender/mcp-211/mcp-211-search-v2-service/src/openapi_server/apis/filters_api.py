...
from openapi_server.apis.filters_api_base import BaseFiltersApi
...
@router.get(
    "/filters/data-owners",
    responses={
        200: {"model": List[DataOwnerDto], "description": "OK"},
...
async def get_filters_data_owners(
    ...
    if not BaseFiltersApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFiltersApi.subclasses[0]().get_filters_data_owners()
...
async def get_filters_location_values_type_type_dataowners_dataowners(
    type: Annotated[StrictStr, Field(description="geography type to filter location values (eg. locality, postalCode, county, state, country). Multiple types not supported.")] = Query(None, description="geography type to filter location values (eg. locality, postalCode, county, state, country). Multiple types not supported.", alias="type"),
    data_owners: Annotated[StrictStr, Field(description="data owner(s) to filter value (e.g. 211ventura OR 211ventura,211northcarolina). See DataOwners API fitler operation for 211 center values.")] = Query(None, description="data owner(s) to filter value (e.g. 211ventura OR 211ventura,211northcarolina). See DataOwners API fitler operation for 211 center values.", alias="dataOwners"),
    type_filter: Annotated[Optional[StrictStr], Field(description="geography type to filter type values (e.g. state). Multiple types not supported.")] = Query(None, description="geography type to filter type values (e.g. state). Multiple types not supported.", alias="typeFilter"),
    type_filter_values: Annotated[Optional[StrictStr], Field(description="value(s) used by type filtergeography type to filter location values (eg. North Carolina OR North Carolina, California). Multiple values supported.")] = Query(None, description="value(s) used by type filtergeography type to filter location values (eg. North Carolina OR North Carolina, California). Multiple values supported.", alias="typeFilterValues"),
    token_apiKeyQuery: TokenModel = Security(
        get_token_apiKeyQuery
    ),
    token_apiKeyHeader: TokenModel = Security(
    ...
    if not BaseFiltersApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFiltersApi.subclasses[0]().get_filters_location_values_type_type_dataowners_dataowners(type, data_owners, type_filter, type_filter_values)
...
async def get_filters_service_area_values_type_type_dataowners_dataowners(
    type: Annotated[StrictStr, Field(description="geography type to filter service area values (eg. locality, postalCode, county, state, country). Multiple type values not supported.")] = Query(None, description="geography type to filter service area values (eg. locality, postalCode, county, state, country). Multiple type values not supported.", alias="type"),
    data_owners: Annotated[StrictStr, Field(description="211 data owner(s) to filter service area values (e.g. 211ventura OR 211ventura,211northcarolina). See DataOwners API fitler operation for 211 center values.")] = Query(None, description="211 data owner(s) to filter service area values (e.g. 211ventura OR 211ventura,211northcarolina). See DataOwners API fitler operation for 211 center values.", alias="dataOwners"),
    type_filter: Annotated[Optional[StrictStr], Field(description="geography type to filter type values (e.g. state). Multiple types not supported.")] = Query(None, description="geography type to filter type values (e.g. state). Multiple types not supported.", alias="typeFilter"),
    type_filter_values: Annotated[Optional[StrictStr], Field(description="value(s) used by type filtergeography type to filter location values (eg. North Carolina OR North Carolina, California). Multiple values supported.")] = Query(None, description="value(s) used by type filtergeography type to filter location values (eg. North Carolina OR North Carolina, California). Multiple values supported.", alias="typeFilterValues"),
    token_apiKeyQuery: TokenModel = Security(
        get_token_apiKeyQuery
    ...
    if not BaseFiltersApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFiltersApi.subclasses[0]().get_filters_service_area_values_type_type_dataowners_dataowners(type, data_owners, type_filter, type_filter_values)
...
async def get_filters_tags_dataowners_dataowners(
    data_owners: Annotated[StrictStr, Field(description="211 data owner(s) to filter values (e.g. 211ventura or 211ventura,211northcarolina).  See DataOwners API fitler operation for 211 center values.")] = Query(None, description="211 data owner(s) to filter values (e.g. 211ventura or 211ventura,211northcarolina).  See DataOwners API fitler operation for 211 center values.", alias="dataOwners"),
    token_apiKeyQuery: TokenModel = Security(
        get_token_apiKeyQuery
    ),
    token_apiKeyHeader: TokenModel = Security(
    ...
    if not BaseFiltersApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFiltersApi.subclasses[0]().get_filters_tags_dataowners_dataowners(data_owners)
...
async def get_filters_target_terms_assigned_dataowners_dataowners(
    ...
    if not BaseFiltersApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFiltersApi.subclasses[0]().get_filters_target_terms_assigned_dataowners_dataowners(data_owners)


@router.get(
    "/filters/taxonomy-level2-terms",
    responses={
        200: {"model": Dict[str, List[object]], "description": "OK"},
        404: {"description": "Not Found"},
    },
    tags=["Filters"],
...
async def get_filters_taxonomy_level2_terms(
    data_owners: Annotated[Optional[StrictStr], Field(description="211 data owner(s) to filter values (e.g. 211ventura or 211ventura,211northcarolina).               See DataOwner API fitler operation for 211 center values. Leave blank if wanting all level 2 terms for all 211s.")] = Query(None, description="211 data owner(s) to filter values (e.g. 211ventura or 211ventura,211northcarolina).               See DataOwner API fitler operation for 211 center values. Leave blank if wanting all level 2 terms for all 211s.", alias="dataOwners"),
    token_apiKeyQuery: TokenModel = Security(
        get_token_apiKeyQuery
    ),
    token_apiKeyHeader: TokenModel = Security(
    ...
    if not BaseFiltersApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFiltersApi.subclasses[0]().get_filters_taxonomy_level2_terms(data_owners)
...
async def get_filters_taxonomy_terms_and_codes_assigned_level_level_levelterm_levelter(
    level: Annotated[StrictStr, Field(description="taxonomy term level to filter values. Accepted values are: 1, 2, 3, 4, 5 or 6. Multiple levels not supported.")] = Query(None, description="taxonomy term level to filter values. Accepted values are: 1, 2, 3, 4, 5 or 6. Multiple levels not supported.", alias="level"),
    level_term: Annotated[StrictStr, Field(description="filters assigned taxonomy terms by term, in combination with the entered level (eg. Basic Needs). See Taxonomy Terms by Level API operation for possible level term values. Multiple terms not supported.")] = Query(None, description="filters assigned taxonomy terms by term, in combination with the entered level (eg. Basic Needs). See Taxonomy Terms by Level API operation for possible level term values. Multiple terms not supported.", alias="levelTerm"),
    data_owners: Annotated[StrictStr, Field(description="211 data owner(s) to filter values(e.g. 211ventura or 211ventura,211northcarolina). See DataOwners API fitler operation for 211 center values.")] = Query(None, description="211 data owner(s) to filter values(e.g. 211ventura or 211ventura,211northcarolina). See DataOwners API fitler operation for 211 center values.", alias="dataOwners"),
    token_apiKeyQuery: TokenModel = Security(
        get_token_apiKeyQuery
    ),
    ...
    if not BaseFiltersApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFiltersApi.subclasses[0]().get_filters_taxonomy_terms_and_codes_assigned_level_level_levelterm_levelter(level, level_term, data_owners)
...
async def get_filters_taxonomy_terms_assigned_level_level_levelterm_levelterm_dataowne(
    level: Annotated[StrictStr, Field(description="level of taxonomy terms to filter values. Accepted values are: 1, 2, 3, 4, 5 or 6. Multiple levels not supported.")] = Query(None, description="level of taxonomy terms to filter values. Accepted values are: 1, 2, 3, 4, 5 or 6. Multiple levels not supported.", alias="level"),
    level_term: Annotated[StrictStr, Field(description="level term to filter values, in combination with the entered level (eg. Basic Needs). See Taxonomy Terms by Level API operation for possible level term values. Multiple terms not supported.")] = Query(None, description="level term to filter values, in combination with the entered level (eg. Basic Needs). See Taxonomy Terms by Level API operation for possible level term values. Multiple terms not supported.", alias="levelTerm"),
    data_owners: Annotated[StrictStr, Field(description="211 data owner(s) to filter values (e.g. 211ventura or 211ventura,211northcarolina). See DataOwners API fitler operation for 211 center values.")] = Query(None, description="211 data owner(s) to filter values (e.g. 211ventura or 211ventura,211northcarolina). See DataOwners API fitler operation for 211 center values.", alias="dataOwners"),
    token_apiKeyQuery: TokenModel = Security(
        get_token_apiKeyQuery
    ),
    ...
    if not BaseFiltersApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFiltersApi.subclasses[0]().get_filters_taxonomy_terms_assigned_level_level_levelterm_levelterm_dataowne(level, level_term, data_owners)
...
async def get_filters_taxonomy_terms_by_level_level_level(
    level: Annotated[StrictStr, Field(description="level of taxonomy to filter values. Accepted values are: 1, 2, 3, 4, 5 or 6. Multiple levels not supported.")] = Query(None, description="level of taxonomy to filter values. Accepted values are: 1, 2, 3, 4, 5 or 6. Multiple levels not supported.", alias="level"),
    data_owners: Annotated[Optional[StrictStr], Field(description="211 data owner(s) to filter values (e.g. 211ventura or 211ventura,211northcarolina). See DataOwners API fitler operation for 211 center values.")] = Query(None, description="211 data owner(s) to filter values (e.g. 211ventura or 211ventura,211northcarolina). See DataOwners API fitler operation for 211 center values.", alias="dataOwners"),
    token_apiKeyQuery: TokenModel = Security(
        get_token_apiKeyQuery
    ),
    ...
    if not BaseFiltersApi.subclasses:
        raise HTTPException(status_code=500, detail="Not implemented")
    return await BaseFiltersApi.subclasses[0]().get_filters_taxonomy_terms_by_level_level_level(level, data_owners)
