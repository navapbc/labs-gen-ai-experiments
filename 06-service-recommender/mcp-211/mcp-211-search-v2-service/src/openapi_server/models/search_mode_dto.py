...
class SearchModeDto(str, Enum):
    """
    Set to 'Any' to match one or more entered search keywords in simple text search. Set to 'All' to match on all search keywords. Default is 'All'.
    """
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of SearchModeDto from a JSON string"""
