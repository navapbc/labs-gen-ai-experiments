...
class FacetValue(BaseModel):
    ...
    FacetValue
    """ # noqa: E501
    value: Optional[StrictStr] = Field(default=None, description="Value of the facet (a filterable field)")
    count: Optional[StrictInt] = Field(default=None, description="Count of resources with the value of the facet")
