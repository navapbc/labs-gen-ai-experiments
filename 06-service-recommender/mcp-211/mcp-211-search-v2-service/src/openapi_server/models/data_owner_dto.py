...
class DataOwnerDto(BaseModel):
    """
    DataOwnerDto
    """ # noqa: E501
    data_owner: Optional[StrictStr] = Field(default=None, alias="dataOwner")
    data_owner_display_name: Optional[StrictStr] = Field(default=None, alias="dataOwnerDisplayName")
    __properties: ClassVar[List[str]] = ["dataOwner", "dataOwnerDisplayName"]
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of DataOwnerDto from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of DataOwnerDto from a dict"""
        if obj is None:
            return None
