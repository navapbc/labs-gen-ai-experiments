...
class SearchOrderby(BaseModel):
    """
    Search Orderby item that identifies the field and order to sort results.
    """ # noqa: E501
    var_field: Annotated[str, Field(min_length=1, strict=True)] = Field(description="The name of the field to use for sorting. Fields are:  * nameOrganization  * nameService  * nameLocation  * nameServiceAtLocation", alias="field")
    value: Optional[Any] = Field(description="The value that sets the sort order (either ascending or descending order). Values are:   * asc  * desc")
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of SearchOrderby from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of SearchOrderby from a dict"""
        if obj is None:
            return None
