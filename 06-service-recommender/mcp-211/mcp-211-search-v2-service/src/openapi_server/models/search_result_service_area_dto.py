...
class SearchResultServiceAreaDto(BaseModel):
    """
    SearchResultServiceAreaDto
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, description="Type of service area (zipcode/postalCode, city, county, state, country)")
    value: Optional[StrictStr] = Field(default=None, description="Value of the of the service area")
    ...
    def from_json(cls, json_str: str) -> Self:
        """Create an instance of SearchResultServiceAreaDto from a JSON string"""
    ...
    def from_dict(cls, obj: Dict) -> Self:
        """Create an instance of SearchResultServiceAreaDto from a dict"""
        if obj is None:
            return None
