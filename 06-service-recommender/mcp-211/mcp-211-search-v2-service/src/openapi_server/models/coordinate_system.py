...
class CoordinateSystem(BaseModel):
    ...
    CoordinateSystem
    """ # noqa: E501
    epsg_id: Optional[StrictInt] = Field(default=None, alias="epsgId")
    id: Optional[StrictStr] = None
    name: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["epsgId", "id", "name"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # set to None if epsg_id (nullable) is None
        # and model_fields_set contains the field
        if self.epsg_id is None and "epsg_id" in self.model_fields_set:
            _dict['epsgId'] = None
